...
let name = "paul";
let languae = "jvascript";
number = 21
let status =true;

console.log("Hello, my name is " + name + ", and I am learning " + language + ". I have been practicing for only " +  number + " weeks, so my status as a master is: " + status + ".");
